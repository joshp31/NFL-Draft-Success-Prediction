...
def main():
    ...
    with open("model results/transformed linear regression results/linear_regression_combine_predictors/summary.txt", "w") as f:
    ...
    plt.savefig("model results/transformed linear regression results/linear_regression_combine_predictors/residuals_vs_fitted.png")
    plt.close()
    ...
    plt.savefig("model results/transformed linear regression results/linear_regression_combine_predictors/actual_vs_predicted.png")
    plt.close()
    ...
    plt.title("Q-Q Plot")
    plt.savefig("model results/transformed linear regression results/linear_regression_combine_predictors/qq_plot.png")
    plt.close()
